%% Initial code runs before the KMC loop, defining constants, inputs, and loading arrays
...
%% Inputs
for gradientHm = [5e3 5e4 5e5 5e6] %migration enthalpy gradient in Kelvin per metre
    ...
    %% All the stuff past this point can be adjusted to fit the actual KMC code
    %% Sandwiching the KMC code
    for iteration = 1:numIterations
        ...
        totalRatesTimesVac = zeros(numEvents+1,2);%first column rate, 2nd time
    ...
    % If we record all the data we can mess around with it later.
    
    postScriptAnalysis_Hm % See separate file
end